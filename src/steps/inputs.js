...
export class InputsState {
     ...
     * while `block_factor` is taken from the property of the same name in the `inputs` property of the `parameters`.
     *
     ...
     * @param {?string} block_factor - Name of the column of the cell annotations specifying the sample of origin for each cell.
     ...
     */
    async compute(datasets, block_factor, subset) {
        this.changed = false;
