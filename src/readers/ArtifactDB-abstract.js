...
export class AbstractArtifactdbDataset {
     ...
     * - `primary_ids`: an object where each key is a modality name and each value is an array (usually of strings) containing the feature identifiers for each row in that modality.
     *
