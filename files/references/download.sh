...
curl -L ${base}/mm-latest/ImmGen_genes.csv.gz > ImmGen_genes.csv.gz
curl -L ${base}/mm-latest/ImmGen_matrix.csv.gz > ImmGen_matrix.csv.gz
curl -L ${base}/mm-latest/ImmGen_label_names_fine.csv.gz > ImmGen_label_names_fine.csv.gz
curl -L ${base}/mm-latest/ImmGen_labels_fine.csv.gz > ImmGen_labels_fine.csv.gz
curl -L ${base}/mm-latest/ImmGen_markers_fine.gmt.gz > ImmGen_markers_fine.gmt.gz
